...
class _ListReflexEvaluatePageState extends State<ListReflexEvaluatePage> {
  ...
  List<String> listMonk = [
    ...
    "กิจกรรมที่ 11 สะท้อนการเรียนรู้",
